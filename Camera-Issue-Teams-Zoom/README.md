...
- Enabled "Turn on basic camera" to use standard camera functionality

## Validation
- Tested 1:1 calls in Teams and Zoom (desktop and browser)
- Confirmed video and audio functioning correctly
- Verified camera feed was visible to an external participant

## Result
Camera functioned normally across all applications after enabling basic camera mode.

## Key Takeaway
Enabling basic camera mode can resolve compatibility issues by bypassing advanced camera features, though some functionality such as virtual backgrounds may be limited.
